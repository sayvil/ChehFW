			...
			<div class="inner">
				<div class="container">
					<div class="nine columns">
						<h1><?php _e('Error 404', 'energy') ?></h1>
						<h2><?php _e('Search for what you are looking for.', 'energy')?></h2>
					</div>
		...
		<div id="content" class="sixteen columns">
			...
			<article class="post">
				...
				<div class="entry" id="error-404">
					...
					<?php _e("Sorry, but we couldn't find the page you were looking for. Please check to make sure you've typed URL correctly. You may also want to search for what you are looking for.", 'energy') ?>
					<br /><br />
					<?php get_template_part('searchform');?>
					<span align="center"><a href="<?php echo home_url(); ?>" target="_self" class="button"><?php _e("Go To Home Page", 'energy') ?></a></span>
