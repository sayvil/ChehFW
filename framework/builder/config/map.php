...
wpb_map( array(
    ...
    "params"    => array(
        array(
            ...
            "description" => __("Select divider style.", "js_composer")
        ),
        array(
            "type" => "textfield",
            ...
            "param_name" => "margin",
            "value" => "15px 0 15px 0",
            "description" => __("Set margin for divider. (e.g. 10px 0 10px 0;)", "js_composer")
        )
    )
));
...
---------------------------------------------------------- */
wpb_map( array(
    "name"		=> __("Separator Title", "js_composer"),
    ...
    "params"	=> array(
        ...
        array(
            ...
            "description" => __("Select heading size.", "js_composer")
        ),
        array(
            "type" => "textfield",
            "heading" => __("Extra class name", "js_composer"),
