	...
	class widget_twitter extends WP_Widget {
					...
					if(!empty($tp_twitter_plugin_tweets)){
						...
						<div class="widget_twitter">';
							...
							foreach($tp_twitter_plugin_tweets as $tweet){								
								print '<div class="tweet"><a class="date" target="_blank" href="http://twitter.com/'.$instance['username'].'/">@'.$instance['username'].'</a><span> '.convert_links($tweet['text']).'</span><br /><a class="date" target="_blank" href="http://twitter.com/'.$instance['username'].'/statuses/'.$tweet['status_id'].'">'.relative_time($tweet['created_at']).'</a></div>';
		...
		//widget settings form	
			public function form($instance) {
				$defaults = array( 'title' => 'Recent tweets', 'consumerkey' => 'gOL3Q6bR1B2OCGGDutVtQ', 'consumersecret' => 'gvtf6wPrxUUzzRSZnVkS1r24g1fcoZfxqjAhpTC2gQ', 'accesstoken' => '593600638-PGezgRfHdabIX9fAxvKTlGMnC3TsZrav1mX79jqR', 'accesstokensecret' => 'tWpGVdpG7ICTEWsyEXg9UCZrGai3sShDi7dsfeiw', 'cachetime' => '5', 'username' => 'artstudioworks', 'tweetstoshow' => '2' );
