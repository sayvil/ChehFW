...
class sidebar_generator {
	...
	function admin_page(){
		...
		<div class="wrap">
			...
			<p>You can generate as many sidebars as you need. Then you can place them on any page you wish.</p>
			<br />
			...
			<div class="add_sidebar">
				<a href="javascript:void(0);" class="button" onclick="return add_sidebar_link()" title="Add a sidebar">Create Sidebar</a>
			</div>
		</div>
		<?php
	}
