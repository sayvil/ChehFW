...
<div class="post clearfix">
	...
	<div class="post-image">
		<a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__('Permalink to %s', THEME_NAME), the_title_attribute('echo=0') ); ?>" rel="bookmark"><div class="no-post-image-link"></div></a>
	</div>
	<?php } ?>	
