    ...
    tinymce.create('tinymce.plugins.dropcap', {  
        init : function(ed, url) {  
            ed.addButton('dropcap', {  
                ...
                onclick : function() {  
                     ed.selection.setContent('[dropcap style="default, circle, box"]A[/dropcap]');  
    ...
    tinymce.create('tinymce.plugins.maps', {  
        init : function(ed, url) {  
            ed.addButton('maps', {  
                ...
                image : url+'/maps.png',  
                onclick : function() {  
                     ed.selection.setContent('[map src="https://maps.google.com/maps?q=New+York,+NY,+United+States&hl=en&ll=40.714184,-74.003992&spn=0.014296,0.033023&sll=47.696472,13.345735&sspn=6.500151,16.907959&oq=new+your&hnear=New+York&t=m&z=16" width="100%" height="410px"]');  
    ...
    tinymce.create('tinymce.plugins.icon', {  
        init : function(ed, url) {  
            ed.addButton('icon', {  
                ...
                image : url+'/icon.png',  
                onclick : function() {  
                     ed.selection.setContent('[icon icon="umbrella" size="in pixels (e.g. 14px)"]');  
    ...
    tinymce.create('tinymce.plugins.iconbox', {  
        init : function(ed, url) {  
            ed.addButton('iconbox', {  
                ...
                onclick : function() {  
                     ed.selection.setContent('[iconbox icon="arrows" icon_size="big or small" title="This is awesome!"]Your Content here...[/iconbox]');  
    ...
    tinymce.create('tinymce.plugins.member', {  
        init : function(ed, url) {  
            ed.addButton('member', {  
                ...
                onclick : function() {  
                     ed.selection.setContent('[member name="John Doe" role="Web Developer" img="http://artstudioworks.net/nopic.png" twitter="http://twitter.com" facebook="http://facebook.com" skype="http://skype.com" google="http://google.de" linkedin="http://linkedin.com" mail="artstudioworks@gmail.com"]Description[/member]');  
    ...
    tinymce.create('tinymce.plugins.socialmedia', {  
        init : function(ed, url) {  
            ed.addButton('socialmedia', {  
                ...
                onclick : function() {  
                     ed.selection.setContent('[social icon="facebook" url="http://facebook.com" style="dark or light" rounded="yes or no"]');  
    ...
    tinymce.create('tinymce.plugins.toggle', {  
        init : function(ed, url) {  
            ed.addButton('toggle', {  
                ...
                onclick : function() {  
                     ed.selection.setContent('[toggle title="Toggle Title" open="true or false" icon="user-1"]Your Content goes here...[/toggle]');  
...
/*-----------------------------------------------------------------------------------*/
/*  Add TinyMCE Container Button
/*-----------------------------------------------------------------------------------*/
(function() {  
    tinymce.create('tinymce.plugins.container', {  
        init : function(ed, url) {  
            ed.addButton('container', {  
                title : 'Add container for Columns',  
                image : url+'/container.png',  
                onclick : function() {  
                     ed.selection.setContent('[container]Your content here...[/container]');  
    ...
    tinymce.create('tinymce.plugins.columns', {  
        init : function(ed, url) {  
            ed.addButton('columns', {  
                ...
                onclick : function() {  
                     ed.selection.setContent('[columns count="eight"]Your content here...[/columns]');  
...
/*-----------------------------------------------------------------------------------*/
/*  Add TinyMCE Clients Button
/*-----------------------------------------------------------------------------------*/
(function() {  
    tinymce.create('tinymce.plugins.clients', {  
        init : function(ed, url) {  
            ed.addButton('clients', {  
                title : 'Add Clients List',  
                image : url+'/clients.png',  
                onclick : function() {  
                     ed.selection.setContent('[clients]your clients list here[/clients]');  
...
/*-----------------------------------------------------------------------------------*/
/*  Add TinyMCE recent comments Button
/*-----------------------------------------------------------------------------------*/
(function() {  
    tinymce.create('tinymce.plugins.recent_comments', {  
        init : function(ed, url) {  
            ed.addButton('recent_comments', {  
                title : 'Add Recent Comments',  
                image : url+'/recent_comments.png',  
                onclick : function() {  
                     ed.selection.setContent('[recent_comments count="5"]');  
                }  
            });  
        },  
        createControl : function(n, cm) {  
    ...
    tinymce.PluginManager.add('recent_comments', tinymce.plugins.recent_comments);  
})();
    ...
    tinymce.create('tinymce.plugins.bloglist', {  
        init : function(ed, url) {  
            ed.addButton('bloglist', {  
                ...
                onclick : function() {  
                     ed.selection.setContent('[bloglist posts="2" title="Latest Posts" style="1 (with date in left side) or 2 (with small thumb in left side)" excerpt_count="18" orderby="popular or date" show_title="yes or no" categories="Category slugs or all"]');  
...
/*-----------------------------------------------------------------------------------*/
/*  Add TinyMCE Testimonial Carousel
/*-----------------------------------------------------------------------------------*/
(function() {  
    tinymce.create('tinymce.plugins.testimonial_carousel', {  
        init : function(ed, url) {  
            ed.addButton('testimonial_carousel', {  
                title : 'Add Testimonial Carousel',  
                image : url+'/testimonial2.png',  
                onclick : function() {  
                     ed.selection.setContent('[testimonial_carousel num="3" thumb_width="47" thumb_height="47"]');  
    ...
    tinymce.PluginManager.add('testimonial_carousel', tinymce.plugins.testimonial_carousel);  
})();